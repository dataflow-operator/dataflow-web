    ...
    messages: {
      en: {
        ...
        flow: {
          ...
          pipelineSettingsMaintenance: 'Maintenance',
          pipelineSettingsMaintenanceStartTime: 'Start time',
          pipelineSettingsMaintenanceStartTimePlaceholder: 'RFC3339',
          pipelineSettingsMaintenanceStartTimeHint: 'Hint',
          pipelineSettingsMaintenanceDuration: 'Duration',
          pipelineSettingsMaintenanceDurationPlaceholder: '2h',
          pipelineSettingsMaintenanceDurationHint: 'Hint',
          pipelineSettingsMaintenanceRepeat: 'Repeat',
          pipelineSettingsMaintenanceRepeatOnce: 'Once',
          pipelineSettingsMaintenanceRepeatDaily: 'Daily',
          pipelineSettingsMaintenanceRepeatWeekly: 'Weekly',
          pipelineSettingsMaintenanceRepeatMonthly: 'Monthly',
          pipelineSettingsMaintenanceTimezone: 'Timezone',
          pipelineSettingsMaintenanceTimezonePlaceholder: 'UTC',
          pipelineSettingsMaintenanceDescription: 'Description',
